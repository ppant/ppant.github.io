...
- **Explainable Concept Drift in Process Mining** – Published research paper in IEEE conference contributing novel methods in AI explainability  
- **Python Architecture Patterns** – Official book reviewer helping developers understand design patterns & best practices  
- **Open Source Projects** – Reporting critical bugs in projects like MySQL Operator and Chromium to improve reliability, contributor to Perl CPAN repository  
